...
None. Production image `localhost:5000/marathon:43cadbf` is deployed, readiness passed, read-only journey smoke passed, and desktop/mobile rendered QA passed without horizontal overflow.
