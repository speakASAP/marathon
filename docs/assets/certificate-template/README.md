...
These are empty medal-specific templates: they include the frame, medal award title, trophy, signature/date guide lines, and site box, but no participant name, marathon/language line, or finish date.
